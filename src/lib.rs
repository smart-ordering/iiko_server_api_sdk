...
pub use xml::response::{
    ...
    InventoryItemStatus, KeyValue, KeyValueEntry, OlapColumnInfo, OlapColumns, OlapFieldValue,
    OlapFilter, OlapReportRequest, OlapReportResponse, OlapReportType, OlapReportTypeV1,
    OrderServiceType, OutgoingInvoiceDto, OutgoingInvoiceItemDto, OutgoingInvoiceItems, PeriodType,
    PreparedChartDto, PreparedChartItemDto, ProductDto, ProductGroupDto, ProductOperationResult,
    ...
    ProductType, ProductWriteoffStrategy, ProductsOperationResult, PublicExternalData, RangeFilter,
    ReferenceEntity, ReferenceEntityDto, ReplicationStatus, ReturnedInvoiceDto,
